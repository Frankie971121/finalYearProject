...
const TenantContract = (props) => {
    ...
    const [totalRentLeftInInt, setTotalRentLeftInInt] = useState(props.contractData.totalRentLeft / 10**18);
    ...
    const signContract = async () => {
        ...
        requestTxSig(
            ...
            [
                {
                    from: props.contractData.tenantAddress,
        ...
        setIsSigned(true);
        console.log(`Contract Signed Receipt: `, result)
    }
    ...
    const payDeposit = async () => {
        ...
        let newAmount = new BigNumber(props.contractData.deposit);
        ...
        let result = await toTxResult(kit.web3.eth.sendSignedTransaction(tx)).waitReceipt()
        setPaidDeposit(true);
        console.log(`Deposit Paid Receipt: `, result)
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.landlord}>
                <Text style={styles.title}>{props.contractData.landlordName}</Text>
            </View>
                    ...
                    overlayStyle={styles.overlay}>
                        <View style={styles.overlayView}>
                            ...
                            <View style={styles.signContainer}>
                                {isSigned ? null :
                                    <Pressable style={styles.signButton} onPress={signContract}>
                                        <Text style={styles.sign}>Sign</Text>
                                    </Pressable> }
                                {paidDeposit ? null :
                                    <Pressable style={styles.payDepositButton} onPress={payDeposit}>
                                ...
                                {isSigned && paidDeposit ? (
                                    <View style={styles.container1}>
                                        ...
                                        <Pressable style={styles.payRentButton} onPress={payRent1}>
                                            <Text style={styles.sign}>Pay Rent</Text>
                                        </Pressable>
                                    </View>) : null }
                                {isSigned && paidDeposit ? 
                                    <Pressable style={styles.withdrawDepositButton} onPress={withdrawDeposit}>
