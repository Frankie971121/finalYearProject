...
import ContractList from './LandlordContract'


export default function LandlordGetContract({navigation}) {

    const [landlordAddress1, setlandlordAddress1] = useState('');
    const landlordAddress1Ref = useRef();
    landlordAddress1Ref.current = landlordAddress1;
    ...
    const login = async () => {
        ...
        // Update state
        setlandlordAddress1(dappkitResponse.address);
    ...
    else if(loading == false && contractData.length == 0 && landlordAddress1 != '') {
